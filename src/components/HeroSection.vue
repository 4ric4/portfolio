            ...
            <div
                ...
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Profissional com experiência em desenvolvimento de software, especialmente em
                        Python e PHP. Atuação na criação e manutenção de bots para web scraping,
                        análise e ciência de dados. Conhecimento em desenvolvimento web com Vue.js,
                        HTML, CSS e JavaScript. Experiência no uso de Docker para desenvolvimento e
                        manutenção de sistemas. Habilidade em programação Apex e desenvolvimento de
                        aplicativos em low-code com Power Apps.
                    </p>
                                ...
                                <div class="svg-container">
                                    <svg class="download-icon " width="18" height="22" viewBox="0 0 18 22" fill="none"
                                        ...
                                        <path d="M1 17V18C1 18.7956 1.31607 19.5587 1.87868 20.1213C2.44129
                                            20.6839 3.20435 21 4 21H14C14.7956 21 15.5587 20.6839 16.1213 20.1213C16.6839
                                            19.5587 17 18.7956 17 18V17" stroke="#f59e0b" stroke-width="2"
                                            stroke-linecap="round" />
                                    </svg>
                                    <div class="download-loader text-white hidden"></div>
                                </div>
                                <a href="/resume.pdf" download="curriculo.pdf" class="pl-2 text-primary">DOWNLOAD
                                    CURRICULO</a>
                            </div>
                        </button>
                ...
                <div class="lg:h-full md:flex">
                    <div
                        ...
                        <div
                            class="absolute z-0 top-1/2 -translate-y=1/2 w-5/6 right-0 h-[calc(80%+20px)] bg-gradient-to-tr opacity-25 from-[#570ac] to-primary blur 2xl">
                        </div>
                        <div
                            ...
                            <img src="/eu.png" alt="Hero pic" width="500" height="auto" loading="lazy" class="w-full h-full rounded-full object-cover" />
