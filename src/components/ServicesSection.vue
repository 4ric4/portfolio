        ...
        <div class="py-8 xl:px-16 px-4 sm:py-16 grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
            <div v-for="service in services" :key="service.id" data-aos="fade-up"
                ...
                <div class="mx-auto h-24 text-center xl:h-28 xl:w-28">
                    <img :src="service.icon" alt="service icon" class="mx-auto h-20 w-20">
                </div>
...
const services = ref([
    {
        ...
        description: 'Desenvolvimento de sites e aplicações web modernas e responsivas.'
    },
    {
        id: 2,
        icon: 'https://img.icons8.com/ios-filled/100/ffffff/data-configuration.png',
        name: 'Data Science',
        description: 'Análise de dados e machine learning para insights avançados.'
    },
    {
        id: 3,
        icon: 'https://img.icons8.com/ios-filled/100/ffffff/server.png',
        name: 'Cloud Solutions',
        description: 'Implantação e gerenciamento de serviços em nuvem.'
    },
    {
        id: 2,
        icon: 'https://img.icons8.com/ios-filled/100/ffffff/data-configuration.png',
