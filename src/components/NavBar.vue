<template>
    <header class="flex justify-between items-center p-6 bg-opacity-50 relative z-20">
        ...
        <!-- Nav bar link -->
        <nav :class="[
            'fixed inset-0 z-20 flex flex-col items-center justify-center bg-[#111827] md:relative md:flex-row md:bg-transparent md:static md:flex md:justify-between md:flex-row',
